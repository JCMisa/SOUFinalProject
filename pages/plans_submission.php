<?php
    ...
    $sql = " SELECT * FROM application_upload WHERE form_type = 'plan_of_activities'; ";
            ...
            <div class="container-fluid">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="row">
                        ...
                        <h1 class="m-0">Plan of Activities Submissions</h1>
                    </div>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="./update_plans_upload.php?details_id='<?php echo $file['id']; ?>'" class="btn btn-block btn-outline-info"> Status </a>
                                </td>
                                <td> 
