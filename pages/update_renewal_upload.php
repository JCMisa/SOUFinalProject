...
if(isset($_POST['submit'])){
    ...
    $query2 = " UPDATE renewal_tbl SET status = '$status' WHERE user_id = $uploader_user_id AND year = '$year'; ";
    $result = mysqli_query($conn, $query);
    $result2 = mysqli_query($conn, $query2);

    if($result && $result2){
        header('location:./renewal_submission.php');
        die();
    }else{
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="row">
                            ...
                            <h1 class="m-0">Set Renewal Submission Status</h1>
                        </div>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
