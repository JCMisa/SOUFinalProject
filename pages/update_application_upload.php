...
if(isset($_POST['submit'])){
    ...
    $query2 = " UPDATE application_tbl SET status = '$status' WHERE user_id = $uploader_user_id AND year = '$year'; ";
            ...
            <div class="content-header">
                <div class="container-fluid">
                    ...
                    <div class="col-sm-6">
                        <!-- go back button -->
                        <div class="row">
                            <a href="./application_submission.php" class="button">
                            ...
                            <h1 class="m-0">Set Application Submission Status</h1>
                        </div>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
