...
if(isset($_POST['submit'])){
    ...
    if(mysqli_num_rows($result) > 0){ //means there is an existing record where user_id = renewal_user_id and year = current year
        ...
        $_SESSION['status'] = "Renewal Created Successfully";
                    ...
                    <tbody>
                        ...
                        ?>
                                    <tr>
                                        ...
                                        <td> <a href="./delete_renewal.php?delete_id='<?php echo $row['id'] ?>'" class="delete btn btn-block btn-outline-danger"> Delete </a> </td>
                                    </tr>
                        <?php
                                }
                            }
